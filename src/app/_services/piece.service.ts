...
export class PieceService {
  ...
  public getPieces(): Observable<Piece[]> {
    return this.http.get<any>(`${this.apiServerUrl}api/piece/all`);
  }

  public addPiece(piece: Piece): Observable<Piece> {
    return this.http.post<Piece>(`${this.apiServerUrl}api/piece/add`, piece);
  }

  public updatePiece(piece: Piece): Observable<Piece> {
    return this.http.put<Piece>(`${this.apiServerUrl}api/piece/update`, piece);
  }

  public deletePiece(pieceId: number): Observable<void> {
    return this.http.delete<void>(
      `${this.apiServerUrl}api/piece/delete/${pieceId}`
    );
  }
